...
| timeInterval | string | Prometheus, Elasticsearch, InfluxDB and MSSQL | Lowest interval/step value that should be used for this data source |
...
| maxOpenConns | number | MSSQL | Maximum number of open connections to the database (Grafana v5.4+) |
| maxIdleConns | number | MSSQL | Maximum number of connections in the idle connection pool (Grafana v5.4+) |
| connMaxLifetime | number | MSSQL | Maximum amount of time in seconds a connection may be reused (Grafana v5.4+) |
