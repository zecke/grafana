...
| timeInterval | string | Prometheus, Elasticsearch, InfluxDB, PostgreSQL and MSSQL | Lowest interval/step value that should be used for this data source |
...
| maxOpenConns | number | PostgreSQL and MSSQL | Maximum number of open connections to the database (Grafana v5.4+) |
| maxIdleConns | number | PostgreSQL and MSSQL | Maximum number of connections in the idle connection pool (Grafana v5.4+) |
| connMaxLifetime | number | PostgreSQL and MSSQL | Maximum amount of time in seconds a connection may be reused (Grafana v5.4+) |
